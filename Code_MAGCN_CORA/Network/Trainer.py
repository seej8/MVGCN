...
def cluster_acc(y_true, y_pred):
    ...
    # Arguments
        y_true :labels, numpy.array with shape `(n_samples,)`
...
class Trainer():
    def __init__(self, args):
        ...
        self.loss, self.H, self.C, self.H2, self.C2, self.pred, self.dense_loss, \
        self.z, self.z2, self.features_loss, self.structure_loss = \
            self.gate(self.A, self.X, self.R, self.S, self.p, self.A2, self.X2, self.R2, self.S2)
